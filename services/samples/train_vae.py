...
def PLM_SA_TRAIN_VAE():
    ...
    ## Removing a previosu VAE and Final VAE
    if os.path.exists("./services/samples/model/vae.pt"):
        os.remove("./services/samples/model/vae.pt")
    if os.path.exists("./services/samples/model/vae-final.pt"):
        os.remove("./services/samples/model/vae-final.pt")
    ...
    IMAGE_SIZE = 128
    IMAGE_PATH = "./services/samples/renders"
    ...
    for epoch in range(EPOCHS):
        for i, (images, _) in enumerate(distr_dl):
            ...
            if i % 100 == 0:
                ...
                save_model(f'./services/samples/model/vae.pt')
    ...
    if distr_backend.is_root_worker():
        ...
        save_model('./services/samples/model/vae-final.pt')
